...
| **Who should decide the treatment of internal and cancelled projects?** | Impose a technical inclusion or exclusion rule in SQL. | **Escalated to business decision** | These records define the contractual population boundary. Profiling and a reversible working treatment were provided, but the final rule belongs to the client. |
